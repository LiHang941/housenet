...
<div id="regLogin" class="wrap">
	<div class="dialog">
		...
		<div class="box">
			<form action="${basePath}admin/updateHouse.do" method="post" id="addHouse">
				<input type="hidden" name="house.id" value="<s:property value="house.id"/>"/>
				<input type="hidden" name="house.userId" value="<s:property value="house.userId"/>"/>
				<div class="infos">
					<table class="field">
						<tr>
							<td class="field">标　　题：</td>
							<td><input type="text" class="text" name="house.title"  value="<s:property value="house.title"/>" /></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td><input type="text" class="text" name="house.floorage" value="<s:property value="house.floorage"/>"/></td>
						</tr>
						<tr>
							<td class="field">价　　格：</td>
							<td><input type="text" class="text" name="house.price"  value="<s:property value="house.price"/>" /></td>
						</tr>
                        <tr>
                        ...
                        <tr>
							...
							<td><input type="text" class="text" name="house.contact" value="<s:property value="house.contact"/>" /></td>
						</tr>
                        <tr>
							<td class="field">详细信息：</td>
							<td><textarea name="house.description"><s:property value="house.description"/></textarea></td>
						</tr>
					</table>
	...
	$(function () {
        ...
        $("#addHouse").submit(
            function () {
                baseAjax(
					{
						url:"${basePath}admin/updateHouse.do",
